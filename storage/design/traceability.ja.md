...
| REQ-PLN-001 | `architecture.ja.md` 命名・plan revision、`ui.ja.md` Plan item/Naming preview | T02、T06、T13、T27 | Core domain/path境界unit test、Plan/preview表示test、`windows_paths.rs` |
...
| REQ-MDA-001〜002、REQ-AST-001〜002 | `scan-pipeline.ja.md`、`architecture.ja.md` metadata不足/asset、`ui.ja.md` Metadata不足 | T15、T16、T28 | Core strategy unit test、`metadata_fixtures.rs`、workflow integration test、UI typecheck/build |
...
- T28: metadata不足時の相対path保持移動、選択可能なfallback方針、およびCLI/Desktop設定。
